      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-azul2/90 max-w-2xl mx-auto mb-8">
            Explora nuestra aplicación real con interfaz moderna y
              ...
              >
                ...
                <m.div
                  ...
                  className={`bg-gradient-to-br from-azul8 to-azul7/60 rounded-lg overflow-hidden ${
                    activeView === "mobile" ? "aspect-[9/16]" : "aspect-[16/10]"
                  }`}
                >
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-azul2/90 text-sm">
                    Frontend moderno con Context Providers, Error Boundaries y
                    routing optimizado
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-azul2/90 text-sm">
                    Comunicación instantánea con Socket.IO y sistema de
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-azul2/90 text-sm">
                    API robusta con módulos independientes: User, Chat, Activity
                    y Friendship
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-azul2/90 text-sm">
                    Interfaz adaptativa que funciona perfectamente en desktop y
                    mobile
                  </p>
                </div>
              </div>
